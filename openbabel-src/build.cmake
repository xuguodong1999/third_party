...
function(xgd_build_openbabel_library)
    set(OB_INC_DIR ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/openbabel/include)
    set(OB_SRC_DIR ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/openbabel/src)
    set(OB_DATA_DIR ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/openbabel/data)
    xgd_add_library(
            openbabel
            SRC_DIRS
            ${OB_SRC_DIR}
