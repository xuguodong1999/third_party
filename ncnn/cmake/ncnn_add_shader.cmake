...
macro(ncnn_add_shader NCNN_SHADER_SRC)
    ...
    add_custom_command(
            ...
            COMMAND ${CMAKE_COMMAND} -DSHADER_SRC=${NCNN_SHADER_SRC} -DSHADER_COMP_HEADER=${NCNN_SHADER_COMP_HEADER} -DXGD_GENERATED_DIR=${XGD_GENERATED_DIR} -P "${XGD_DEPS_DIR}/ncnn/cmake/ncnn_generate_shader_comp_header.cmake"
