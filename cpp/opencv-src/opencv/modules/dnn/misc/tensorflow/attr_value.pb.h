...
inline void AttrValue_ListValue::set_s(int index, const void* value,
                              std::size_t size) {
  _impl_.s_.Mutable(index)->assign(reinterpret_cast<const char*>(value), size);
...
inline void AttrValue_ListValue::set_s(int index, absl::string_view value) {
  _impl_.s_.Mutable(index)->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_set_string_piece:opencv_tensorflow.AttrValue.ListValue.s)
}
inline std::string* AttrValue_ListValue::_internal_add_s() { return _impl_.s_.Add(); }
...
inline void AttrValue_ListValue::add_s(absl::string_view value) {
  _impl_.s_.Add()->assign(value.data(), value.size());
...
inline void AttrValue_ListValue::_internal_add_i(::int64_t value) { _impl_.i_.Add(value); }
...
inline void AttrValue_ListValue::_internal_add_f(float value) { _impl_.f_.Add(value); }
...
inline void AttrValue_ListValue::_internal_add_b(bool value) { _impl_.b_.Add(value); }
...
inline ::opencv_tensorflow::DataType AttrValue_ListValue::_internal_type(int index) const {
  return static_cast<::opencv_tensorflow::DataType>(_impl_.type_.Get(index));
}
