function(xgd_build_rdkit_library)
    set(RD_ROOT_DIR ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/rdkit)
    ...
    xgd_link_coordgen(rdkit_Depictor)
    ...
    xgd_link_rdkit(rdkit_ChemTransforms PUBLIC SubstructMatch SmilesParse GraphMol RDGeometryLib RDGeneral Depictor)
    xgd_link_rdkit(rdkit_CIPLabeler PUBLIC GraphMol RDGeneral)
    xgd_link_rdkit(rdkit_DataStructs PUBLIC RDGeneral)
    xgd_link_rdkit(rdkit_Depictor PUBLIC SmilesParse SubstructMatch MolTransforms GraphMol RDGeometryLib RDGeneral)
