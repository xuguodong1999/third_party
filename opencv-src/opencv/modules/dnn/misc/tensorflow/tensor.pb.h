...
class TensorProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& _internal_string_val() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* _internal_mutable_string_val();
...
inline std::string* TensorProto::_internal_add_string_val() {
  return _internal_mutable_string_val()->Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
