...
PROTOBUF_NAMESPACE_OPEN
template <>
::opencv_tensorflow::TensorShapeProto* Arena::CreateMaybeMessage<::opencv_tensorflow::TensorShapeProto>(Arena*);
template <>
::opencv_tensorflow::TensorShapeProto_Dim* Arena::CreateMaybeMessage<::opencv_tensorflow::TensorShapeProto_Dim>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class TensorShapeProto final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::opencv_tensorflow::TensorShapeProto_Dim>& _internal_dim() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::opencv_tensorflow::TensorShapeProto_Dim>* _internal_mutable_dim();
  public:
