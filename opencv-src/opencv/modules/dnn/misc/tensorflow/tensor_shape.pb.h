...
#ifndef tensor_5fshape_2eproto_2epb_2eh
#define tensor_5fshape_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:opencv_tensorflow.TensorShapeProto.Dim) */ {
 public:
  ...
  void operator delete(TensorShapeProto_Dim* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  TensorShapeProto_Dim* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // tensor_5fshape_2eproto_2epb_2eh
