...
#ifndef function_2eproto_2epb_2eh
#define function_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:opencv_tensorflow.GradientDef) */ {
 public:
  ...
  void operator delete(GradientDef* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GradientDef* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:opencv_tensorflow.FunctionDef.Node) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(FunctionDef_Node* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(FunctionDef_Node));
  }
#endif
  ...
  FunctionDef_Node* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:opencv_tensorflow.FunctionDefLibrary) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(FunctionDefLibrary* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  FunctionDefLibrary* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // function_2eproto_2epb_2eh
