...
PROTOBUF_NAMESPACE_OPEN
template <>
::opencv_tensorflow::FunctionDef* Arena::CreateMaybeMessage<::opencv_tensorflow::FunctionDef>(Arena*);
template <>
::opencv_tensorflow::FunctionDefLibrary* Arena::CreateMaybeMessage<::opencv_tensorflow::FunctionDefLibrary>(Arena*);
template <>
::opencv_tensorflow::FunctionDef_Node* Arena::CreateMaybeMessage<::opencv_tensorflow::FunctionDef_Node>(Arena*);
template <>
::opencv_tensorflow::FunctionDef_Node_AttrEntry_DoNotUse* Arena::CreateMaybeMessage<::opencv_tensorflow::FunctionDef_Node_AttrEntry_DoNotUse>(Arena*);
template <>
::opencv_tensorflow::GradientDef* Arena::CreateMaybeMessage<::opencv_tensorflow::GradientDef>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class FunctionDefLibrary final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::opencv_tensorflow::FunctionDef>& _internal_function() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::opencv_tensorflow::FunctionDef>* _internal_mutable_function();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::opencv_tensorflow::GradientDef>& _internal_gradient() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::opencv_tensorflow::GradientDef>* _internal_mutable_gradient();
  public:
...
class FunctionDef_Node_AttrEntry_DoNotUse final : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<FunctionDef_Node_AttrEntry_DoNotUse, 
...
class FunctionDef_Node final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& _internal_ret() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* _internal_mutable_ret();
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& _internal_arg() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* _internal_mutable_arg();
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& _internal_dep() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* _internal_mutable_dep();
...
class FunctionDef final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::opencv_tensorflow::FunctionDef_Node>& _internal_node() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::opencv_tensorflow::FunctionDef_Node>* _internal_mutable_node();
  public:
...
class GradientDef final :
 ...
 public:
  ...
  void set_allocated_gradient_func(std::string* ptr);
...
inline ::opencv_tensorflow::GradientDef* FunctionDefLibrary::_internal_add_gradient() {
  return _internal_mutable_gradient()->Add();
}
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* FunctionDef_Node::mutable_ret() {
...
inline std::string* FunctionDef_Node::_internal_add_ret() {
  return _internal_mutable_ret()->Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* FunctionDef_Node::mutable_arg() {
...
inline std::string* FunctionDef_Node::_internal_add_arg() {
  return _internal_mutable_arg()->Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* FunctionDef_Node::mutable_dep() {
...
inline std::string* FunctionDef_Node::_internal_add_dep() {
  return _internal_mutable_dep()->Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
...
inline PROTOBUF_ALWAYS_INLINE void GradientDef::set_gradient_func(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.gradient_func_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void GradientDef::set_allocated_gradient_func(std::string* value) {
  _impl_.gradient_func_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
