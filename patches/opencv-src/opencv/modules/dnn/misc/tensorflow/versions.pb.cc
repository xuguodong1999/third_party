...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<VersionDef>(),
...
const ::google::protobuf::MessageLite::ClassData* VersionDef::GetClassData() const {
            ...
            // repeated int32 bad_consumers = 3;
             {
              std::size_t data_size = ::_pbi::WireFormatLite::Int32Size(
                  this_._internal_bad_consumers())
              ;
              this_._impl_._bad_consumers_cached_byte_size_.Set(
