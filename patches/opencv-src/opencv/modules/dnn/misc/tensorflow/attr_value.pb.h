...
#ifndef attr_5fvalue_2eproto_2epb_2eh
#define attr_5fvalue_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:opencv_tensorflow.AttrValue.ListValue) */ {
 public:
  ...
  void operator delete(AttrValue_ListValue* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  AttrValue_ListValue* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:opencv_tensorflow.AttrValue) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(AttrValue* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  AttrValue* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:opencv_tensorflow.NameAttrList) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(NameAttrList* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  NameAttrList* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // attr_5fvalue_2eproto_2epb_2eh
