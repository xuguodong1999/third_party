...
#ifndef versions_2eproto_2epb_2eh
#define versions_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:opencv_tensorflow.VersionDef) */ {
 public:
  ...
  void operator delete(VersionDef* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  VersionDef* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // versions_2eproto_2epb_2eh
