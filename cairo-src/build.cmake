# cairo
function(xgd_build_cairo_library)
    set(ROOT_DIR ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/cairo)
    ...
    set(CAIRO_HAS_IMAGE_SURFACE 1)
    set(CAIRO_HAS_USER_FONT 1)
    list(APPEND CAIRO_SRC_FILES ${CAIRO_PNG_SRC_FILES} ${CAIRO_SVG_SRC_FILES} ${CAIRO_PDF_SRC_FILES} ${CAIRO_PS_SRC_FILES})
    if (WIN32)
    ...
    add_dependencies(cairo pixman)
    target_link_libraries(cairo PRIVATE pixman)
    if (NOT APPLE)
        add_dependencies(cairo freetype)
        target_link_libraries(cairo PRIVATE freetype)
    endif ()
    xgd_link_png(cairo)
